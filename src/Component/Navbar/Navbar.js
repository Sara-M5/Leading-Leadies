...
const Navbar = () => {
  return (
    <nav className="navbar fixed-top navbar-expand-md navbar-light bg-white m-auto mb-3">
      <div className="container d-flex justify-content-between align-items-center">
        ...
        <button
          className="navbar-toggler btn0 m-0"
          ...
          <ul className="navbar-nav">
            ...
            <li className="nav-item dropdown">
              ...
              <div className="dropdown-menu">
                <NavLink
                  to="/ShopFullWidth"
                  className="dropdown-item text-dark btn1"
                >
                  Shop Full Width
                </NavLink>
            ...
            <li className="nav-item">
              ...
              >
                <div class="cart-contents-count">
                  <i className="mx-2 fa fa-shopping-cart"></i>0 items{" "}
                </div>
              </NavLink>
            </li>
          </ul>
