...
const Home = () => {
     ...
     return(
        ...
        <button>All Items</button></div>
        <p >Nemo enim ipsam voluptatem quia voluptas aspernatur</p></div>
       ...
       <div className="row">
          ...
          <Text title="Latest From Blog" /></div>
          <div className="Blog">
          <div className="row">
        ...
        <div>
        <p className="textColor">Over 75,000 designers and developers trust the DigiMarket.</p>
        </div>
       </div>
        <LastPart />
